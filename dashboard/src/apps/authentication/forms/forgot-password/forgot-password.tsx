...
// Services
import authenticationService, { ForgotPasswordRequest } from '@startup/services/authentication';
...
const ForgotPasswordForm: React.FunctionComponent<ForgotPasswordProps> = ({ onSuccess }) => {
	const { handleChange, handleSubmit, values, errors, isSubmitting } = useFormik<ForgotPasswordRequest>({
		initialValues: {
			email: ''
		},
		validationSchema,
