        ...
        for (let i = 0; i < list.length; i++) {
            if (list[i].subItems) {
                ...
                return [
                    ...
                    (haveIndex ? index! : 1) *
                        subIndexes[subIndexes.length - 1],
                ];
            } else if (
        ...
        <Layout style={{ minHeight: '100vh' }}>
            <Sider collapsible collapsed={collapsed} onCollapse={setCollapsed}>
                ...
                <Menu
                    theme="dark"
                    defaultSelectedKeys={[
                        `main-menu-${selectedIndex[selectedIndex.length - 1]}`,
                    ]}
                    defaultOpenKeys={selectedIndex.map(
                ...
                >
                    {navigation.map(
                        (
                            { title, icon: Icon, path, subItems, permissions },
                            index
                        ) => {
            ...
            <Layout className="site-layout" style={{ maxHeight: '100vh' }}>
                ...
                <Content style={{ overflowY: 'auto' }}>
                    <div style={{ padding: 36, minHeight: 360 }}>
                        {children}
                    </div>
                </Content>
            </Layout>
